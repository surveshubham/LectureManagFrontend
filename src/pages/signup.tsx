...
const signup = () => {
    ...
    const signUp = async (e: any) => {
        ...
        const response = await fetch(`http://localhost:8080/api/createInstructor`, {
            method: "POST",
            headers: {
    ...
    return (
        <div className="mx-auto max-w-7xl py-10 gird place-items-center h-screen px-5">
            ...
            <form className=" mx-auto">
                ...
                <div className='pt-5 '>
                    <button className='bg-red-500 px-5 py-2 text-white font-bold' onClick={signUp}>Sign Up</button>
                </div>
            </form>
        </div>
    )
